...
<div class="content-container">
  ...
  <div class="container-fluid mt-5">
    ...
    <div class="jumbotron">
      <h1>JOB PROFILE</h1>
      <a href="jobAdd.php" class="btn btn-primary mb-3 float-right">+Add Restaurant</a>
        ...
        ?>
          ...
          <tr>
            ...
            <td><?php $check = $row['job_status'];
              ...
              | <a href="restaDelete.php?id=<?php echo $row['job_id']; ?>"><i title="Delete" class="far fa-trash-alt text-danger"></i></a>
            </td>
          </tr>
